...
if __name__ == '__main__':
    ...
    epoch_output_dir = '/home/work/waka/projects/pytorch-pretrained-BERT/samples/QLP/result/base/epoch2/'
    ...
    json_dump(top1_result, '../samples/QLP/self_bert_epoch2_top1.json')
    json_dump(result, '../samples/QLP/self_bert_epoch2.json')
