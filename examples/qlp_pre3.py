...
def add_negative_samples(samples):
    ...
    for sample in samples:
        ...
        result.append([neg_sample[0], sample[1], sample[2], sample[3], '0'])
        result.append([sample[0], neg_sample[1], sample[2], sample[3], '0'])
        result.append([sample[0], sample[1], neg_sample[2], sample[3], '0'])
        result.append([sample[0], sample[1], sample[2], neg_sample[3], '0'])
    return result
...
if __name__ == '__main__':
    ...
    with open('../samples/QLP/data/fullAd/Random/train.tsv', 'w', encoding='utf8') as f:
    ...
    with open('../samples/QLP/data/fullAd/Random/test.tsv', 'w', encoding='utf8') as f:
    ...
    with open('../samples/QLP/data/fullAd/Random/dev.tsv', 'w', encoding='utf8') as f:
